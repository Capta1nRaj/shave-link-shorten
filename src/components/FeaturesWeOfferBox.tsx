    ...
    return (
        <>
            <section className="FeaturesWeOfferBox-section">
                <section className="box- sm:w-[474px] w-auto h-full min-h-[190px] bg-primary-1 p-5 rounded-xl drop-shadow-[0_0px_4px_rgba(242,242,242,0.25)]">
                    ...
                    <p className={`${montserrat.className} font-normal description text-base mt-4`}>
                        {description}
                    </p>
