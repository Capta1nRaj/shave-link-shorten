...
export default function Example() {
    ...
    return (
        <div className="isolate bg-primary-1 px-6 py-24 sm:py-32 lg:px-8 relative">
            <div
                className="absolute inset-x-0 top-0 -z-10 transform-gpu overflow-hidden blur-3xl"
                aria-hidden="true"
            >
                <div
                    className="relative top-20 left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none rotate-[30deg] bg-gradient-to-tr from-[#00ABF0] to-[#040406] opacity-30 sm:left-[calc(50%-25rem)] sm:w-[72.1875rem]"
                    style={{
                        clipPath:
            ...
            <div className="mx-auto max-w-2xl text-center">
                <h2 className="titleCSS text-primary-3">Contact Us</h2>
            </div>
