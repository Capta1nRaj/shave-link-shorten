...
export default function DarkModeCodeBackup() {
            ...
            <div className="flow-root bg-gray-900 pb-16 pt-24 sm:pt-32 lg:pb-0">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="relative z-10">
                        <h2 className="mx-auto max-w-4xl text-center sm:text-5xl text-4xl font-bold tracking-tight text-primary-4 capitalize">
                            <p className=''> uncomplicated, </p>
                            <p className='sm:mt-2 mt-0 text-primary-3'> value for money </p>
                        </h2>
                        ...
                        {PricingTiersConstants.map((tier, index) => (
                            <div
                                ...
                                className={classNames(
                                    tier.featured
                                        ? 'z-10 bg-primary-1 shadow-xl ring-1 ring-gray-900/10'
                                ...
                                <div className="p-8 lg:pt-12 xl:p-10 xl:pt-14">
                                    <h3 id={tier.id}
                                        className={classNames(
                                            tier.featured ? 'text-primary-3' : 'text-primary-4',
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between lg:flex-col lg:items-stretch">
                                        <div className="mt-2 flex flex-col">
                                            ...
                                            <section className="top flex items-center gap-x-2">
                                                ...
                                                <p className={classNames(tier.featured ? 'text-primary-3' : 'text-primary-4', 'text-4xl font-bold tracking-tight')}>
                                                    {country.value === 'in'
                                                ...
                                                <span className={`text-sm font-semibold leading-6 ${index !== 2 ? "text-primary-4" : "text-primary-3"}`}>
                                                    {index !== 3 &&
                                                        <>
                                                            /month
                                                        </>
                                            ...
                                            {index === 0 ? (
                                                ...
                                                <p className={`text-sm text-primary-3 capitalize mt-2 ${index !== 2 ? "text-primary-4" : "text-primary-3"}`}>
                                        ...
                                        <Link href={tier.href} aria-describedby={tier.id}
                                            className={`${tier.featured
                                                ? 'bg-primary-5 border border-primary-3 text-white shadow-sm hover:bg-primary-3'
                                        ...
                                        <ul role="list"
                                            ...
                                            {tier.features.map((mainFeature) => (
                                                <li key={mainFeature} className="flex gap-x-3 py-2">
                                                    <CheckIcon
                                                        className={classNames(
                                                            tier.featured ? 'text-primary-4' : 'text-primary-3',
                                                            'h-6 w-5 flex-none',
                                                        )}
                                                        aria-hidden="true"
                                                    />
                ...
                <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
                    ...
                    <section aria-labelledby="mobile-comparison-heading" className="lg:hidden">
                        ...
                        <div className="mx-auto max-w-2xl space-y-16">
                            {PricingTiersConstants.map((tier) => (
                                <div key={tier.id} className="border-t border-primary-3">
                                    <div className={classNames(
                                        ...
                                        <p className="mt-1 text-sm leading-6 text-primary-4">{tier.description}</p>
                                    </div>

                                    <div className="mt-10 space-y-10">
                                        {sections.map((section) => (
                                            <div key={section.name}>
                                                <h4 className="text-sm font-semibold leading-6 text-primary-4">{section.name}</h4>
                                                <div className="relative mt-6">
                                                    {/* Fake card background */}
                                                    <div
                                                        aria-hidden="true"
                                                        className="absolute inset-y-0 right-0 hidden w-1/2 rounded-lg bg-primary-1 shadow-sm sm:block"
                                                    />

                                                    <div
                                                        className={classNames(
                                                            tier.featured ? 'ring-2 ring-primary-3' : 'ring-1 ring-gray-900/10',
                                                            'relative rounded-lg bg-primary-1 shadow-sm sm:rounded-none sm:bg-transparent sm:shadow-none sm:ring-0',
                                                        )}>
                                                        <dl className="divide-y divide-gray-200 text-sm leading-6">
                                                            {section.features.map((feature) => (
                                                                <div key={feature.name}
                                                                    className="flex items-center justify-between px-4 py-3 sm:grid sm:grid-cols-2 sm:px-0">
                                                                    <dt className="pr-4 text-primary-3">{feature.name}</dt>
                                                                    <dd className="flex items-center justify-end sm:justify-center sm:px-4">
                                                                        {typeof feature.tiers[tier.name as keyof typeof feature.tiers] === 'string' ? (
                                                                            <span
                                                                                className={tier.featured ? 'font-semibold text-primary-3' : 'text-primary-4'}
                                                                            >
                                                                            ...
                                                                            <>
                                                                                {feature.tiers[tier.name as keyof typeof feature.tiers] === true ? (
                                                                                    <CheckIcon className="mx-auto h-5 w-5 text-primary-3" aria-hidden="true" />
                                                                                ) : (
                                                                                    <XMarkIcon className="mx-auto h-5 w-5 text-primary-4" aria-hidden="true" />
                                                                                )}
                    ...
                    <section aria-labelledby="comparison-heading" className="hidden lg:block">
                        ...
                        <div className="grid grid-cols-5 gap-x-8 border-t border-gray-900/10 before:block">
                            {PricingTiersConstants.map((tier) => (
                                <div key={tier.id} aria-hidden="true" className="-mt-px">
                                    <div
                                        className={classNames(
                                            tier.featured ? 'border-primary-3' : 'border-primary-4',
                                            'border-t-2 pt-10',
                                        )}>
                                        <p className={classNames(
                                            tier.featured ? 'text-primary-3' : 'text-primary-4',
                        ...
                        <div className="-mt-6 space-y-16">
                            {sections.map((section) => (
                                <div key={section.name}>
                                    <h3 className="text-base font-semibold leading-6 text-primary-4">{section.name}</h3>
                                    <div className="relative -mx-8 mt-10">
                                        {/* Fake card backgrounds */}
                                        <div className="absolute inset-x-8 inset-y-0 grid grid-cols-5 gap-x-8 before:block" aria-hidden="true">
                                            <div className="h-full w-full rounded-lg bg-primary-1 shadow-sm" />
                                            <div className="h-full w-full rounded-lg bg-primary-1 shadow-sm" />
                                            <div className="h-full w-full rounded-lg bg-primary-1 shadow-sm" />
                                            <div className="h-full w-full rounded-lg bg-primary-1 shadow-sm" />
                                        </div>
                                        ...
                                        <table className="relative w-full border-separate border-spacing-x-8">
                                            ...
                                            <tbody>
                                                {section.features.map((feature, featureIdx) => (
                                                    <tr key={feature.name}>
                                                        <th scope="row" className="w-1/5 py-3 pr-4 text-left text-sm font-normal leading-6 text-primary-3">
                                                            {feature.name}
                                                        ...
                                                        {PricingTiersConstants.map((tier) => (
                                                            <td key={tier.id} className="relative w-1/5 px-4 py-0 text-center">
                                                                <span className="relative h-full w-full py-3">
                                                                    {typeof feature.tiers[tier.name as keyof typeof feature.tiers] === 'string' ? (
                                                                        <span
                                                                            className={classNames(tier.featured ? 'font-semibold text-primary-3' : 'text-primary-4', 'text-sm leading-6')}>
                                                                            {feature.tiers[tier.name as keyof typeof feature.tiers]}
                                                                        </span>
                                                                    ) : (
                                                                        <>
                                                                            {feature.tiers[tier.name as keyof typeof feature.tiers] === true ? (
                                                                                ...
                                                                                <XMarkIcon className="mx-auto h-5 w-5 text-red-600" aria-hidden="true" />
                                                                            )}
                                        ...
                                        {/* Fake card borders */}
                                        <div aria-hidden="true" className="pointer-events-none absolute inset-x-8 inset-y-0 grid grid-cols-5 gap-x-8 before:block">
                                            {PricingTiersConstants.map((tier) => (
                                                <div
                                                    key={tier.id}
                                                    className={classNames(
