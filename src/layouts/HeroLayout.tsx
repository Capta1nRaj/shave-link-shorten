...
const customTitleCSS = `lg:text-7xl md:text-6xl sm:text-5xl text-3xl text-center uppercase font-extrabold lg:leading-7xl md:leading-6xl sm:leading-5xl leading-3xl uppercase`;
        ...
        <section id="home" className={`IntroLayout-section ${raleway.className} font-extrabold py-16 bg-custom-dark`}>
            <section className="max-width">
                ...
                <div className="flex items-center justify-center">
                    <Link href={'/signup'}>
                        <ShimmerButton
                            className="shadow-2xl hover:bg-custom-blue transition-all ease-in-out duration-200"
                            shimmerColor="#00ABF0"
                        >
                            <SparklesText text="start boosting business" className="sm:text-2xl text-base uppercase" />
                        </ShimmerButton>
                    </Link>
                </div>
